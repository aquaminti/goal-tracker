    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.brand}>
          <img src="https://www.iconpacks.net/icons/2/free-goal-and-target-icon-2854-thumb.png" alt="logo" style={{ width: 36, height: 36 }} />
          <span>GoalTracker</span>
        </div>
        <h1 style={styles.heading}>Создать аккаунт</h1>
        <p style={styles.sub}>Выполняй свои цели</p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.field}>
            ...
            <input
              ...
              onChange={handleChange} placeholder="Шахан Шаханулы"
          ...
          <div style={styles.field}>
            ...
            <input
              ...
              onChange={handleChange} placeholder="mail@mail.ru"
              style={styles.input} required
            />
          </div>
          <div style={styles.field}>
